...
If you are creating checks for your Trivy misconfiguration scans, all fields are optional. The `schemas` field should be used to enable policy validation using a built-in schema. The 
